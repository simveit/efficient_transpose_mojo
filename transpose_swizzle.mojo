...
def run_transpose_swizzle(ctx: DeviceContext):
    print("== run_transpose_swizzle")
    ...
    for _ in range(num_warmup):
        ctx.enqueue_function[transpose_kernel_swizzle[BLOCK_SIZE]](
            descriptor,
            descriptor_tr,
